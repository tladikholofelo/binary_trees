...
/**
 * bal - Measures the balance factor of a AVL
 * @tree: Double pointer to the tree to traverse
 *
 ...
 *
 * Return: If it has no children - 0.
 */
 ...
 *
 * Return: The changed tree after removing the node.
 */
